    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!-- AKHIR TOMBOL -->
                <!-- MULAI TABLE -->
                <table class="table table-striped table-bordered table-sm" id="table_pegawai1">
                    <thead>
                        <tr>
                            <th>Nama</th>
                            <th>JK</th>
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) { //jika berhasil 
                            ...
                            var oTable = $('#table_pegawai1').dataTable(); //inialisasi datatable
            ...
            $.ajax({
                ...
                success: function (data) { //jika sukses
                    setTimeout(function () {
                        ...
                        var oTable = $('#table_pegawai1').dataTable();
                        oTable.fnDraw(false); //reset datatable
                    });
